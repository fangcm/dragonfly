...
namespace Dragonfly.Plugin.Task
{
    internal class SchedulerRegistry : Registry
    {
        ...
        public SchedulerRegistry()
        {
            ...
            Logger.info("main", "delayMinutes", delayMinutes, "remainingMinutes", remainingMinutes, "interval", interval);

            Logger.info("main", "ToRunEvery(", interval, ") DelayFor(", delayMinutes, ").Minutes()");


            if (remainingMinutes > 0)
            {
                Logger.info("main", "ToRunNow, remainingMinutes", remainingMinutes);
            }
